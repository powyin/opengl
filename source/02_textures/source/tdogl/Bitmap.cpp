...
Bitmap Bitmap::bitmapFromFile(std::string filePath) {    
	...
	//switch (bmp.format()) {
	//case Format_RGB:
	//    size = bmp._width * bmp._height;  // *bmp._format;
	//	unsigned char byte;
	//	for (int i = 0; i < size; i++) {
	//		byte = bmp._pixels[i*bmp._format];
	//		bmp._pixels[i*bmp._format] = bmp._pixels[i*bmp._format + 2];
	//		bmp._pixels[i*bmp._format + 2] = byte;
	//	}
	//	break;
	//default:
	//		break;
