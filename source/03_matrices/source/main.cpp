...
static void LoadShaders() {
    ...
    glm::mat4 camera = glm::lookAt(glm::vec3(0,0,7), glm::vec3(0,0,0), glm::vec3(0.0f,1,0));
...
static void Render() {
  ...
  //  gProgram->setUniform("model", glm::rotate(glm::mat4(), glm::radians(gDegreesRotated), glm::vec3(0,1,0)));
	...
	glm::mat4 rotate;
	rotate = glm::rotate(rotate, glm::radians(gDegreesRotated), glm::vec3(0, 1, 0));

	glm::mat4 translate;
	translate = glm::translate(translate, glm::vec3(1.0f, 0.0f, 0.0f));

	gProgram->setUniform("model", translate * rotate );
